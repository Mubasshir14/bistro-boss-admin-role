                        ...
                        <div className="w-full px-6 py-8 md:px-8 lg:w-1/2">
                            ...
                            <form onSubmit={handleLogIn}>
                                <div className="mt-4">
                                    ...
                                    <input id="LoggingEmailAddress" className="block w-full px-4 py-2 text-gray-700 bg-white border rounded-lg dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-400 focus:ring-opacity-40 dark:focus:border-blue-300 focus:outline-none focus:ring focus:ring-blue-300" name='email' placeholder='Email' type="email" />
                                </div>
                                <div className="mt-4">
                                    ...
                                    <input className="block w-full px-4 py-2 text-gray-700 bg-white border rounded-lg dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-400 focus:ring-opacity-40 dark:focus:border-blue-300 focus:outline-none focus:ring focus:ring-blue-300" name='password' placeholder='Password' type="password" />
                                </div>
                                {/* captcha */}
                                <div className="mt-4 form-control">
                                    <label className="label  ">
                                        <LoadCanvasTemplate className='input input-bordered' />
                                    </label>
                                    <input onBlur={handleValidateCaptcha}  type="text" name="captcha" className=' block w-full px-4 py-2 text-gray-700 bg-white border rounded-lg dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-400 focus:ring-opacity-40 dark:focus:border-blue-300 focus:outline-none focus:ring focus:ring-blue-300' placeholder='Type The Captcha Above' required id="" />
                                    
                                </div>

                                <div className="mt-6">
                                    <input disabled={disabled} className="w-full px-6 py-3 text-sm font-medium tracking-wide text-white capitalize transition-colors duration-300 transform bg-[#D1A054B3] rounded-lg hover:bg-gray-700 focus:outline-none focus:ring focus:ring-gray-300 focus:ring-opacity-50" type="submit" value="SIgn In" />
                                </div>
                            </form>
